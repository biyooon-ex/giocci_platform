  ...
  defp check_root_dockerfile(errors, versions) do
    ...
    errors =
      check_match(
        ...
        file,
        content,
        ~r/^ARG ELIXIR_VERSION=#{Regex.escape(elixir_version)}$/m,
    ...
    errors =
      check_match(
        ...
        file,
        content,
        ~r/^ARG ERLANG_VERSION=#{Regex.escape(erlang_version)}$/m,
    ...
    errors =
      check_match(
        ...
        file,
        content,
        ~r/^ARG UBUNTU_VERSION=#{Regex.escape(ubuntu_version)}$/m,
